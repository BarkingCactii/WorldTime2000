...
void CWorldTime2000View::DrawTooltip ( CMemDC & memDC )
{
	DEBUGLINE ( __FILE__, __LINE__ );
	 ...
	 if ( selected >= 0 )
	     sprintf ( buf, "GMT is %.1fhrs. Alarm is %s", li->offset, buf2 ); //( char * )li->name );
	 else
