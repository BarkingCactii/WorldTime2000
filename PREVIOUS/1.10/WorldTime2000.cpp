...
int CWorldTime2000App::CheckRegistration ( void )
{
	...
	if ( l.terminatingDay != day || l.terminatingMonth != month )
	{
		...
		{
	        MessageBox ( m_pMainWnd->m_hWnd, "An error has occurred. This probably registered version is now un-registered. Please contact us with your name, address, phone & email for more information", "Trial version Problem", MB_OK | MB_ICONERROR );
			l.registeredName = "Trial version";
			l.registeredCRC = 0x00000000;
